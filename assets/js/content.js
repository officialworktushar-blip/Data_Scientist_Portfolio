    ...
    items: [
      {
        ...
        gradient: 'linear-gradient(135deg,#6600FF,#9900FF)',
        ...
        chart: { type: 'line', data: [61, 68, 74, 79, 85, 89, 94], color: '#9900FF' },
        href: 'projects.html'
      },
      {
        id: 'p2',
        ...
        gradient: 'linear-gradient(135deg,#FD7702,#FFBB00)',
        ...
        chart: { type: 'line', data: [100, 132, 170, 210, 258, 300, 340], color: '#FD7702' },
        href: 'projects.html'
      },
      {
        id: 'p3',
        ...
        gradient: 'linear-gradient(135deg,#22DDDD,#4CD963)',
        ...
        chart: { type: 'bars', data: [72, 81, 88, 93, 97, 99, 99.2], color: '#4CD963' },
        href: 'projects.html'
      },
      {
        id: 'p4',
        ...
        gradient: 'linear-gradient(135deg,#0099FF,#00CCFF)',
        ...
        chart: { type: 'line', data: [96, 91, 84, 77, 71, 67, 63], color: '#00CCFF' },
        href: 'projects.html'
      },
      {
        id: 'p5',
        ...
        icon: 'fas fa-users',
        gradient: 'linear-gradient(135deg,#FF0066,#FFBB00)',
        ...
        chart: { type: 'bars', data: [18, 24, 29, 33, 36, 39, 41], color: '#FFBB00' },
        href: 'projects.html'
      },
      {
        id: 'p6',
        ...
        gradient: 'linear-gradient(135deg,#6600FF,#0099FF)',
        ...
        chart: { type: 'line', data: [54, 61, 68, 73, 79, 84, 87], color: '#0099FF' },
        href: 'projects.html'
      }
    ],
  ...
  portfolio: {
    ...
    projects: [
      ...
      },
      {
        ...
        filter: 'genai',
        icon: 'fas fa-comments',
        gradient: 'linear-gradient(135deg,#FF0066,#FD7702)',
      ...
      },
      {
        ...
        filter: 'ecommerce',
        icon: 'fas fa-eye',
        gradient: 'linear-gradient(135deg,#0099FF,#9900FF)',
      ...
      },
      {
        ...
        filter: 'genai',
        icon: 'fas fa-heart',
        gradient: 'linear-gradient(135deg,#FF0066,#FF0022)',
      ...
      },
      {
        ...
        filter: 'supply',
        icon: 'fas fa-truck',
        gradient: 'linear-gradient(135deg,#9900FF,#FF0066)',
